...
export class ReferralsController {
  ...
  async importConnections(
    ...
    const result = await this.referralsService.importConnections(
      user._id.toString(),
      parsed,
    );
  ...
  async getConnections(
    ...
    return this.referralsService.getConnections(
      user._id.toString(),
      company,
      status,
    );
  ...
  async findReferrals(
    ...
    return this.referralsService.findReferrals(
      user._id.toString(),
      jobListingId,
    );
  }
  ...
  async getRequests(
    ...
    return this.referralsService.getReferralRequests(
      user._id.toString(),
      status,
    );
  }
  ...
  async updateRequest(
    ...
    return this.referralsService.updateReferralRequest(
      id,
      user._id.toString(),
      body,
    );
