              ...
              <div className="card !shadow-sm">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-2">
                  {[
                    ...
                    <div key={m.label}>
                      <span className="label-uppercase text-[9px]" style={{ color: m.value >= 75 ? '#16A34A' : m.value >= 50 ? '#D97706' : '#DC2626' }}>{m.label}</span>
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    {[
                      ...
                      { icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D97706" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg>, title: 'ATS score for any job', desc: 'Match against real job descriptions.', iconBg: 'bg-amber-light' },
                      { icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4F46E5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>, title: 'Cover letter', desc: 'Generated from your resume and JD.', iconBg: 'bg-teal-light' },
                      { icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4F46E5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><line x1="9" y1="10" x2="15" y2="10"/></svg>, title: 'Mock interview', desc: 'Voice interview with AI that read your resume.', iconBg: 'bg-teal-light' },
                      { icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D97706" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg>, title: 'Discover jobs', desc: 'Feed scored against your resume.', iconBg: 'bg-amber-light' },
                      { icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D97706" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>, title: 'Portfolio check', desc: 'Compare your site against your resume claims.', iconBg: 'bg-amber-light' },
