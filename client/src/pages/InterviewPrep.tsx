...
import { IconBrain, IconMicrophone, IconPlayerPlay, IconAlertTriangle } from '@tabler/icons-react'
          ...
          <>
            <div className="bg-paper-dark rounded-lg p-6 space-y-4">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-teal to-purple-500 flex items-center justify-center">
